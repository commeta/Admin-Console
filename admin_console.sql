...
INSERT INTO `md_portfolio_img` VALUES (1,1,'','Нет звука приятнее, чем старческий скрип Амстердама','gallery',0),(3,3,'','Глубокий уровень погружения определил дальнейшее развитие','gallery',0),(4,4,'','Доблесть наших правозащитников разочаровала','gallery',0),(2,2,'','Может показаться странным, но объемы выросли','gallery',0);
...
INSERT INTO `md_users_login` VALUES (21,1,'','178.130.37.64','2020-04-23 02:27:15','0c3b75d70dae04adbff7dd4e335fb3485fe285e0314e8f1e25a27b73e8f2020f');
...
-- Dump completed on 2020-04-23 22:00:04
