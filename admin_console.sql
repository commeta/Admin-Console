...
CREATE TABLE `md_blog` (
  ...
  PRIMARY KEY (`id`),
  KEY `friendly_url` (`friendly_url`(250)),
...
CREATE TABLE `md_comments` (
  ...
  `public_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
--
-- Table structure for table `md_likes`
--

DROP TABLE IF EXISTS `md_likes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `md_likes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `md_likes`
--
...
INSERT INTO `md_send` VALUES (13,7,'2020-05-12 16:25:10','Тестовое сообщение','127.0.0.1');
...
CREATE TABLE `md_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role` smallint(1) NOT NULL COMMENT '0 - пользователь, 1 - админ',
  ...
  `gender` smallint(1) NOT NULL COMMENT '0 - не указан, 1 - М, 2 - Ж',
  `birthday` date NOT NULL,
  `phone` varchar(255) NOT NULL,
  `photo_url` varchar(500) NOT NULL,
  `news_check` smallint(1) NOT NULL COMMENT 'Согласие на получение рассылки',
...
CREATE TABLE `md_users_login` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `status` varchar(12) NOT NULL COMMENT 'anonymous|registered|authorized',
...
--
-- Table structure for table `md_users_security`
--

DROP TABLE IF EXISTS `md_users_security`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `md_users_security`
--

LOCK TABLES `md_users_security` WRITE;
/*!40000 ALTER TABLE `md_users_security` DISABLE KEYS */;
/*!40000 ALTER TABLE `md_users_security` ENABLE KEYS */;
UNLOCK TABLES;
